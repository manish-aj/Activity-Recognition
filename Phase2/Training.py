...
def preprocess():
    ...
    dataset6 = pd.read_csv(r"MealNoMealData\Nomeal1.csv", usecols = [i for i in range(0,30)], header=None)
    dataset7 = pd.read_csv(r"MealNoMealData\Nomeal2.csv", usecols = [i for i in range(0,30)], header=None)
    dataset8 = pd.read_csv(r"MealNoMealData\Nomeal3.csv", usecols = [i for i in range(0,30)], header=None)
    dataset9 = pd.read_csv(r"MealNoMealData\Nomeal4.csv", usecols = [i for i in range(0,30)], header=None)
    dataset10 = pd.read_csv(r"MealNoMealData\Nomeal5.csv", usecols = [i for i in range(0,30)], header=None)
...
def Scaling(X_train):
    ...
    #os.chdir(os.getcwd() + "\Assignment 2 - Group 34")
